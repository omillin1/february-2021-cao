...
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/ECMWF/Corr_Plots/lowpv_corr_ESS_ECMWF.png", bbox_inches = 'tight', dpi = 500)
...
# Set colorbar tick size.
cbar.ax.tick_params(labelsize=13)
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/ECMWF/Corr_Plots/highpv_corr_ESS_ECMWF.png", bbox_inches = 'tight', dpi = 500)

# Take average correlations and print them.
ave_corr_low = np.nanmean(corr_low)
ave_corr_high = np.nanmean(corr_high)
print("Average low PV correlation on 2nd Feb is:", ave_corr_low) # 0.888
print("Average high PV correlation on 2nd Feb is:", ave_corr_high) # 0.833
...
# Set colorbar tick size.
cbar.ax.tick_params(labelsize=13)
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/ECMWF/Diff_Plots/diff_ESS_ECMWF.png", bbox_inches = 'tight', dpi = 500)
