...
fig_no = np.arange(1, 6, 1)
# Set labels for figures.
labels = ['a) LOW PV 1', 'LOW PV 2', 'LOW PV 3', 'LOW PV 4', 'LOW PV 5']
...
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/ECMWF/Corr_Plots/lowpv_corr_LS_ECMWF.png", bbox_inches = 'tight', dpi = 500)


# Set labels for figures.
labels = ['a) HIGH PV 1', 'HIGH PV 2', 'HIGH PV 3', 'HIGH PV 4', 'HIGH PV 5']
# Generate figure amnd set figure size.
fig = plt.figure(figsize=(12, 6))
...
# Set colorbar tick size.
cbar.ax.tick_params(labelsize=13)
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/ECMWF/Corr_Plots/highpv_corr_LS_ECMWF.png", bbox_inches = 'tight', dpi = 500)

# Take average correlations and print them.
ave_corr_low = np.nanmean(corr_low)
ave_corr_high = np.nanmean(corr_high)
print("Average low PV correlation on 2nd Feb is:", ave_corr_low) # 0.512
print("Average high PV correlation on 2nd Feb is:", ave_corr_high) # 0.03
...
# Set colorbar tick size.
cbar.ax.tick_params(labelsize=13)
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/ECMWF/Diff_Plots/diff_LS_ECMWF.png", bbox_inches = 'tight', dpi = 500)
