...
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/NCEP/Corr_Plots/lowpv_corr_LS_NCEP.png", bbox_inches = 'tight', dpi = 500)
...
# Set colorbar tick size.
cbar.ax.tick_params(labelsize=13)
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/NCEP/Corr_Plots/highpv_corr_LS_NCEP.png", bbox_inches = 'tight', dpi = 500)

# Take average correlations and print them.
ave_corr_low = np.nanmean(corr_low)
ave_corr_high = np.nanmean(corr_high)
print("Average low PV correlation on 2nd Feb is:", ave_corr_low) # 0.135
print("Average high PV correlation on 2nd Feb is:", ave_corr_high) # 0.272
...
# Set colorbar tick size.
cbar.ax.tick_params(labelsize=13)
plt.savefig("/share/data1/Students/ollie/CAOs/project-2021-cao/main/Pattern_Correlations/NCEP/Diff_Plots/diff_LS_NCEP.png", bbox_inches = 'tight', dpi = 500)
