...
# Save the figure.
plt.savefig(f'/share/data1/Students/ollie/CAOs/project-2021-cao/main/S2S_Models/PV_Maps/Wave_Break_Reverse/NCEP/ess_wb_ncep_t2m_{date_str}.png', bbox_inches = 'tight', dpi = 500)
...
plt.tight_layout()
plt.savefig(f'/share/data1/Students/ollie/CAOs/project-2021-cao/main/S2S_Models/PV_Maps/Wave_Break_Reverse/NCEP/ess_wb_ncep_pv_{date_str}.png', bbox_inches = 'tight', dpi = 500)
