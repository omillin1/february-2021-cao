...
# Save the figure.
plt.savefig(f'/share/data1/Students/ollie/CAOs/project-2021-cao/main/S2S_Models/PV_Maps/Wave_Break_Reverse/NCEP/test_{date_str}_canada_t2m_ncep.png', bbox_inches = 'tight', dpi = 500)
...
plt.tight_layout()
plt.savefig(f'/share/data1/Students/ollie/CAOs/project-2021-cao/main/S2S_Models/PV_Maps/Wave_Break_Reverse/NCEP/test_{date_str}_canada_pv_ncep.png', bbox_inches = 'tight', dpi = 500)
