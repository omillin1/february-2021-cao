...
# Save the figure.
plt.savefig(f'/share/data1/Students/ollie/CAOs/project-2021-cao/main/S2S_Models/PV_Maps/Wave_Break_Reverse/ECMWF/test_{date_str}_greenland_t2m_ecmwf.png', bbox_inches = 'tight', dpi = 500)
